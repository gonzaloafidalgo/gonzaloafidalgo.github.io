...
BLOG_AUTHOR = "Gonzalo Alvarez Fidalgo"  # (translatable)
BLOG_TITLE = "Gonzolo's test page"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://gonzolo.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://gonzolo.com/"
BLOG_EMAIL = "gonzaloalvarezfidalgo@gmail.com"
BLOG_DESCRIPTION = "Test site I created using Nikola"  # (translatable)
